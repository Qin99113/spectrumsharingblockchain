...
const (
	Msg_UpdateParams_FullMethodName  = "/spectrumsharingblockchain.spectrumrequest.Msg/UpdateParams"
	Msg_CreateRequest_FullMethodName = "/spectrumsharingblockchain.spectrumrequest.Msg/CreateRequest"
)
